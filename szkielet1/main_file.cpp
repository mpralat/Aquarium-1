...
glm::vec3 camera_position(0.0, 3.0, 0.0);
...
int main()
{
	...
	ActivateShaderProgram(aquariumGlassShaders);
	...
	ActivateShaderProgram(aquariumShaders);
	...
	while (RenderingEnabled())
	{
		...
		// Wyslanie perspektywy i kamery do programu shadera
		glUniformMatrix4fv(view_uniform_aq_glass, 1, GL_FALSE, glm::value_ptr(view_matrix));
		glUniformMatrix4fv(perspective_uniform_aq_glass, 1, GL_FALSE, glm::value_ptr(perspective));
